        ...
        if (ratesEl) {
            ratesEl.innerHTML = `
                ...
                <div style="color:#475569; line-height:1.6;">
                    ...
                    <span style="font-size:11px; color:#94a3b8;">(182 mld PLN / wykonanie za rok 2025)</span>
                </div>`;
        }
            ...
            config.parties.forEach(p => {
                ...
                card.innerHTML = `
                    ...
                    <div class="bottom-analytics">
                        <div class="label">Audyt i Sejm</div>
                        ...
                        ${(p.legislative_initiatives || []).map(leg => `<a href="${leg.url}" target="_blank" class="sub-link"><div class="s-icon">S</div> <span>${leg.text}</span></a>`).join('')}
                    </div>
                `;
