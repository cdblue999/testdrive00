...
const translations = {
    pl: {
        ...
        days: "dni", market: "RYNEK I WSKAŹNIKI (LIVE)", statusTitle: "STATUSY RATINGOWE",
        aaa: "Realizacja (AAA)", bbb: "W procesie (BBB)", d: "Brak (D)", sentiment: "SENTYMENT",
        critTitle: "Analiza krytyczna / Media",
        news: " PILNE: Polska gospodarka przyspiesza • GUS potwierdza spadek inflacji • Stabilizacja na rynkach • ",
    ...
    en: {
        ...
        days: "days", market: "MARKET INDICATORS (LIVE)", statusTitle: "RATING STATUS",
        aaa: "Completed (AAA)", bbb: "In progress (BBB)", d: "Failed (D)", sentiment: "SENTIMENT",
        critTitle: "Critical Analysis / Media",
        news: " BREAKING: Polish economy gains momentum • Stats office confirms inflation drop • ",
    ...
    de: {
        ...
        days: "Tage", market: "MARKTINDIKATOREN (LIVE)", statusTitle: "RATING-STATUS",
        aaa: "Erledigt (AAA)", bbb: "In Bearbeitung (BBB)", d: "Fehlgeschlagen (D)", sentiment: "STIMMUNG",
        critTitle: "Kritische Analyse / Medien",
        news: " EILMELDUNG: Polnische Wirtschaft nimmt an Fahrt auf • BIP-Prognosen stabil • ",
        ...
        jsonData.parties.forEach(p => {
            ...
            card.innerHTML = `
                ...
                <div class="critical-section">
                    ...
                    `).join('') : '<span style="font-size:10px; color:#cbd5e1;">Brak analiz</span>'}
                </div>`;
            app.appendChild(card);
        });
    } catch (e) { app.innerHTML = '<div style="grid-column:1/-1; text-align:center; padding:50px;">Błąd danych. Sprawdź plik data.json.</div>'; }
}
